...
class AdminRelatedTest extends TestCase {
     ...
     * @test
     */
    public function testSearchForBroker() {
        // search for broekrs search
        $recipeName = 'getAllBrokers';

        //$brokers = setRecipe($recipeName, null);
        $brokers = 'rand';
        $this->assertNotNull($brokers);
